                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="../../controllers/UserController.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="author" class="form-label">Email: <span class="text-danger">*</span></label>
                                <input type="text" id="email" name="email" class="form-control">
                            </div>

                            <div class="mb-3">
                                <label for="category" class="form-label">Jméno:</label>
                                <input type="text" id="name" name="name" class="form-control">
                            </div>

                            <div class="mb-3">
                                <label for="subcategory" class="form-label">Příjmení:</label>
                            ...
                            <button type="submit" class="btn btn-success w-100">Registrovat uživatele</button>
                        </form>
                    </div>
                </div>
            </div>
